...
public class XHook {
    ...
    public synchronized boolean init(Context ctx) {
        ...
        try {
            ...
            try {
                System.load(ctx.getFilesDir().getParent() + "/lib/libxhookdemo.so");
                inited = true;
            } catch (Throwable ex) {
                ex.printStackTrace();
                Log.e("xhook", "load libxhookdemo.so failed");
            }
        }
        return inited;
    }
    ...
    public synchronized void refresh(boolean async) {
        ...
        try {
            com.example.xhookdemo.NativeHandler.getInstance().refresh(async);
        } catch (Throwable ex) {
            ex.printStackTrace();
    ...
    public synchronized void clear() {
        ...
        try {
            com.example.xhookdemo.NativeHandler.getInstance().clear();
        } catch (Throwable ex) {
            ex.printStackTrace();
    ...
    public synchronized void enableDebug(boolean flag) {
        ...
        try {
            com.example.xhookdemo.NativeHandler.getInstance().enableDebug(flag);
        } catch (Throwable ex) {
            ex.printStackTrace();
    ...
    public synchronized void enableSigSegvProtection(boolean flag) {
        ...
        try {
            com.example.xhookdemo.NativeHandler.getInstance().enableSigSegvProtection(flag);
        } catch (Throwable ex) {
            ex.printStackTrace();
    ...
    {
        try{
            com.example.xhookdemo.NativeHandler.getInstance().InitHook(true);
        }catch (Throwable ex) {
            ex.printStackTrace();
